...
import { Code, Activity } from 'react-feather';

export default function Blogs() {
    return (
        <section className="blogs bg-white pt-10">
            <div className="container px-5">
                <div className="row gx-5 mb-10">
                    <div className="col-lg-6 mb-5 mb-lg-0 divider-right" data-aos="fade">
                        <div className="testimonial p-lg-5">
                            ...
                            <p className="testimonial-quote text-primary">"Lorem ipsum dolor, sit amet consectetur
                    ...
                    <div className="col-lg-6" data-aos="fade" data-aos-delay="100">
                        <div className="testimonial p-lg-5">
                            ...
                            <p className="testimonial-quote text-primary">"Adipisci mollitia nemo magnam iure,
                            ...
                            <div className="testimonial-position">Technical Project Manager</div>
                        </div>
                    </div>
                </div>
                <div className="row gx-5">
                        ...
                        <a className="card text-decoration-none h-100 lift" href="#!">
                            <div className="card-body py-5">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="ms-4">
                                        <h5 className="text-primary">Work smarter, not harder</h5>
                                        <p className="card-text text-gray-600">Learn more about how our product can
                    ...
                    <div className="col-lg-6 mb-lg-n10 z-1">
                        <a className="card text-decoration-none h-100 lift" href="#!">
                            <div className="card-body py-5">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="ms-4">
                                        <h5 className="text-secondary">Built for developers</h5>
                                        <p className="card-text text-gray-600">Our components, utilities, and
